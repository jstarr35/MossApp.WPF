...
<ArrayOfString xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
  <string>C,C,c,.c,.h</string>
  <string>C++,f,cc,.cpp,.h,.hpp,.cc</string>
  <string>Java,J,java,.java</string>
  <string>Haskell,H,haskell,.hs</string>
  <string>Fortran,s,fortran,.f90,.f95,.f03</string>
  <string>Python,q,python,.py</string>
  <string>C#,r,csharp,.cs</string>
  <string>JavaScript,j,javascript,.js</string>
  <string>PL/SQL,y,plsql,.json</string>
  <string>Meta Language,M,ml,.ml</string>
  <string>Pascal,p,pascal,.pas</string>
  <string>Ada,A,ada,.ada</string>
  <string>Lisp,l,lisp,.lisp</string>
  <string>Scheme,B,scheme,.scm</string>
  <string>ASCII,a,ascii,.asc,.txt</string>
  <string>VHDL,c,vhdl,.vhdl</string>
  <string>Perl,P,perl,.perl,.pl</string>
  <string>Matlab,m,matlab,.matlab</string>
  <string>MIPS,N,mips,.s,.asm</string>
  <string>Spice,w,spice,.sp</string>
  <string>VisualBasic,v,vb,.vb</string>
  <string>Modula2,O,modula2,.mod</string>
  <string>A8086,x,a8086,.asm</string>
</ArrayOfString>")]
